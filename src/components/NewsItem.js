      ...
      <div>
        <div className="card mb-3">
          ...
          <div className="card-body">
            ...
            <p className="card-text" style={description !== null ? {height : '78px', overflow: 'hidden'} : {}}>{description}</p>
            <a href={newsUrl} className="btn btn-sm btn-dark mt-1" target="_blank" rel="noreferrer">
             Read more
            </a>
          </div>
        </div>
